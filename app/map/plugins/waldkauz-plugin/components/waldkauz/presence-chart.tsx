// app/map/plugins/waldkauz-plugin/components/waldkauz/presence-chart.tsx
"use client";
...
import type { LoadState, PresenceBucketJson } from "./types";
...
async function fetchPresence(fileBase: string): Promise<PresenceBucketJson> {
	...
	const res = await fetch(`/data/plugins/waldkauz/json/${encodeURIComponent(fileBase)}.json`, { cache: "force-cache" });
