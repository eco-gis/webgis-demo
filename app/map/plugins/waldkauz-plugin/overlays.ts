...
const sources: Record<string, SourceSpecification> = {
	[WALDKAUZ_SOURCE_IDS.points]: { type: "geojson", data: "/data/plugins/waldkauz/waldkauz_location.geojson" },
	[WALDKAUZ_SOURCE_IDS.buffer500]: { type: "geojson", data: "/data/plugins/waldkauz/buffer_500.geojson" },
	[WALDKAUZ_SOURCE_IDS.buffer1000]: { type: "geojson", data: "/data/plugins/waldkauz/buffer_1000.geojson" },
	[WALDKAUZ_SOURCE_IDS.buffer2000]: { type: "geojson", data: "/data/plugins/waldkauz/buffer_2000.geojson" },
};
